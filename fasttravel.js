$('#hintName').addEventListener('change', function() {
    ...
    button.innerHTML = "GO"; 
    button.id = "cords";
    button.style = " font-size: 24px; background-color: #2f2f2f; color: rgb(204, 204, 204); width: 60px; float: right; position: relative; margin-top: -35px; margin-right: 5px; z-index: 100;"
